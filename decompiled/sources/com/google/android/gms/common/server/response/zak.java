...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo13446id = 2)
    private final ArrayList<zal> zaqv;
    @SafeParcelable.Field(getter = "getRootClassName", mo13446id = 3)
    private final String zaqw;

    @Constructor
    zak(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) ArrayList<zal> arrayList, @Param(mo13449id = 3) String str) {
        this.zale = i;
        this.zaqv = null;
