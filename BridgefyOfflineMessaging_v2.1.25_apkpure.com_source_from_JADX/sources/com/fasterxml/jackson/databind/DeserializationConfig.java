...
public final class DeserializationConfig extends MapperConfigBase<DeserializationFeature, DeserializationConfig> implements Serializable {
    ...
    protected DeserializationConfig(DeserializationConfig deserializationConfig, SimpleMixInResolver simpleMixInResolver, RootNameLookup rootNameLookup, ConfigOverrides configOverrides) {
        super((MapperConfigBase<CFG, T>) deserializationConfig, simpleMixInResolver, rootNameLookup, configOverrides);
        this._deserFeatures = deserializationConfig._deserFeatures;
        this._problemHandlers = deserializationConfig._problemHandlers;
        this._nodeFactory = deserializationConfig._nodeFactory;
        this._parserFeatures = deserializationConfig._parserFeatures;
    ...
    public DeserializationConfig with(MapperFeature mapperFeature, boolean z) {
        ...
        DeserializationConfig deserializationConfig = new DeserializationConfig(this, i2, this._deserFeatures, this._parserFeatures, this._parserFeaturesToChange, this._formatReadFeatures, this._formatReadFeaturesToChange);
        return deserializationConfig;
    }
    ...
    public DeserializationConfig without(Feature feature) {
        ...
        DeserializationConfig deserializationConfig = new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, i, mask, this._formatReadFeatures, this._formatReadFeaturesToChange);
        return deserializationConfig;
    }
    ...
    public DeserializationConfig with(FormatFeature formatFeature) {
        ...
        DeserializationConfig deserializationConfig = new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, this._parserFeatures, this._parserFeaturesToChange, mask, mask2);
        return deserializationConfig;
    }
    ...
    public DeserializationConfig withFeatures(FormatFeature... formatFeatureArr) {
        ...
        DeserializationConfig deserializationConfig = new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, this._parserFeatures, this._parserFeaturesToChange, i3, i4);
        return deserializationConfig;
    }
    ...
    public DeserializationConfig without(FormatFeature formatFeature) {
        ...
        DeserializationConfig deserializationConfig = new DeserializationConfig(this, this._mapperFeatures, this._deserFeatures, this._parserFeatures, this._parserFeaturesToChange, i, mask);
        return deserializationConfig;
    }
