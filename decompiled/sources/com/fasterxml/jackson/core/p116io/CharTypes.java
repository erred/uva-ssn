...
public final class CharTypes {
    ...
    /* renamed from: HB */
    private static final byte[] f6135HB;

    /* renamed from: HC */
    private static final char[] f6136HC = "0123456789ABCDEF".toCharArray();
    ...
    static {
        int length = f6136HC.length;
        f6135HB = new byte[length];
        for (int i = 0; i < length; i++) {
            f6135HB[i] = (byte) f6136HC[i];
        }
        ...
        for (int i = 0; i < length2; i++) {
            ...
            if (charAt >= length || iArr[charAt] == 0) {
                ...
                if (i2 < 0) {
                    ...
                    sb.append('0');
                    sb.append('0');
                    sb.append(f6136HC[charAt >> 4]);
                    sb.append(f6136HC[charAt & 15]);
                } else {
                    sb.append((char) i2);
                }
            }
    ...
    public static char[] copyHexChars() {
        return (char[]) f6136HC.clone();
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f6135HB.clone();
    }
}
