...
interface zzjl {
    ...
    void zza(int i, zzeh zzeh) throws IOException;

    <K, V> void zza(int i, zzgv<K, V> zzgv, Map<K, V> map) throws IOException;
    ...
    @Deprecated
    void zzap(int i) throws IOException;

    @Deprecated
    void zzaq(int i) throws IOException;
    ...
    void zzb(int i, List<zzeh> list) throws IOException;
