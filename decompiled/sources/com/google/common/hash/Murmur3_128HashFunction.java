...
final class Murmur3_128HashFunction extends AbstractStreamingHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f6768C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f6769C2 = 5545529020109919103L;
        private static final int CHUNK_SIZE = 16;

        /* renamed from: h1 */
        private long f6770h1;

        /* renamed from: h2 */
        private long f6771h2;
        ...
        private void bmix64(long j, long j2) {
            this.f6770h1 = mixK1(j) ^ this.f6770h1;
            this.f6770h1 = Long.rotateLeft(this.f6770h1, 27);
            this.f6770h1 += this.f6771h2;
            this.f6770h1 = (this.f6770h1 * 5) + 1390208809;
            this.f6771h2 ^= mixK2(j2);
            this.f6771h2 = Long.rotateLeft(this.f6771h2, 31);
            this.f6771h2 += this.f6770h1;
            this.f6771h2 = (this.f6771h2 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f6770h1 = mixK1(r2) ^ r11.f6770h1;
            r11.f6771h2 = mixK2(r0) ^ r11.f6771h2;
         */
        ...
        public HashCode makeHash() {
            this.f6770h1 ^= (long) this.length;
            this.f6771h2 ^= (long) this.length;
            this.f6770h1 += this.f6771h2;
            this.f6771h2 += this.f6770h1;
            this.f6770h1 = fmix64(this.f6770h1);
            this.f6771h2 = fmix64(this.f6771h2);
            this.f6770h1 += this.f6771h2;
            this.f6771h2 += this.f6770h1;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f6770h1).putLong(this.f6771h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f6768C1, 31) * f6769C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f6769C2, 33) * f6768C1;
        }
    }
