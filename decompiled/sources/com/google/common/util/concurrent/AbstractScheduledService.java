...
public abstract class AbstractScheduledService implements Service {
    ...
    public final AbstractService delegate = new AbstractService() {
        ...
        public final Runnable task = new Runnable() {
            public void run() {
                C27501.this.lock.lock();
                try {
                    AbstractScheduledService.this.runOneIteration();
                    C27501.this.lock.unlock();
                } catch (Throwable th) {
                    C27501.this.lock.unlock();
                    throw th;
                }
            ...
            this.executorService.execute(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        C27501.this.runningTask = AbstractScheduledService.this.scheduler().schedule(AbstractScheduledService.this.delegate, C27501.this.executorService, C27501.this.task);
                        C27501.this.notifyStarted();
                        C27501.this.lock.unlock();
                    } catch (Throwable th) {
                        C27501.this.lock.unlock();
                        throw th;
        ...
        public final void doStop() {
            ...
            this.executorService.execute(new Runnable() {
                public void run() {
                    try {
                        C27501.this.lock.lock();
                        if (C27501.this.state() != State.STOPPING) {
                            C27501.this.lock.unlock();
                            return;
                        }
                        AbstractScheduledService.this.shutDown();
                        C27501.this.lock.unlock();
                        C27501.this.notifyStopped();
                    } catch (Throwable th) {
                        C27501.this.notifyFailed(th);
