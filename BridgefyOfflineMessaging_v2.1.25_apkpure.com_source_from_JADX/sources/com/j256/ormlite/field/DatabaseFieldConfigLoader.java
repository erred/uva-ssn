                ...
                if (readLine != null && !readLine.equals(CONFIG_FILE_END_MARKER)) {
                    if (readLine.length() != 0 && !readLine.startsWith("#") && !readLine.equals(CONFIG_FILE_START_MARKER)) {
                        ...
                        if (split.length == 2) {
                            ...
                            sb.append("DatabaseFieldConfig reading from stream cannot parse line: ");
                            sb.append(readLine);
            ...
            if (split.length == 2) {
                try {
                    ...
                    if (enumConstants != null) {
                        ...
                        if (!z) {
                            StringBuilder sb = new StringBuilder();
                            sb.append("Invalid enum value name for unknownEnumvalue: ");
                            sb.append(str2);
                            throw new IllegalArgumentException(sb.toString());
                        }
                        return;
                    ...
                    sb3.append("Unknown class specified for unknownEnumValue: ");
                    sb3.append(str2);
                    throw new IllegalArgumentException(sb3.toString());
                }
            } else {
                StringBuilder sb4 = new StringBuilder();
                sb4.append("Invalid value for unknownEnumValue which should be in class#name format: ");
                sb4.append(str2);
