...
final class zzcr extends zzau {
    ...
    private final int zza(java.net.URL r4, byte[] r5) {
        ...
        L_0x0020:
            ...
            com.google.android.gms.internal.measurement.zzal r0 = r3.zzcc()     // Catch:{ IOException -> 0x006e, all -> 0x006b }
    ...
    private final HttpURLConnection zzb(URL url) throws IOException {
        ...
        if (openConnection instanceof HttpURLConnection) {
            ...
            httpURLConnection.setRequestProperty(HttpHeaders.USER_AGENT, this.zzabl);
