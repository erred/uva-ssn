...
public class PeriodFormatterBuilder {
    ...
    static class Composite implements PeriodParser, PeriodPrinter {
        ...
        public int countFieldsToPrint(ReadablePeriod readablePeriod, int i, Locale locale) {
            ...
            while (i2 < i) {
                ...
                i2 += periodPrinterArr[length].countFieldsToPrint(readablePeriod, BaseClientBuilder.API_PRIORITY_OTHER, locale);
            }
            return i2;
        }
    ...
    static class FieldFormatter implements PeriodParser, PeriodPrinter {
        ...
        public int calculatePrintedLength(ReadablePeriod readablePeriod, Locale locale) {
            ...
            if (this.iPrefix != null) {
                max += this.iPrefix.calculatePrintedLength(i2);
            }
            if (this.iSuffix != null) {
                max += this.iSuffix.calculatePrintedLength(i2);
            }
            return max;
        }
        ...
        public int parseInto(ReadWritablePeriod readWritablePeriod, String str, int i, Locale locale) {
            ...
            while (i7 < i3) {
                ...
                if (i7 == 0 && ((charAt == '-' || charAt == '+') && !this.iRejectSignedValues)) {
                    ...
                    if (charAt < '0' || charAt > '9') {
                        if ((charAt != '.' && charAt != ',') || ((this.iFieldType != 8 && this.iFieldType != 9) || i8 >= 0)) {
                            break;
                        }
                        int i11 = i9 + 1;
                        i3 = Math.min(i3 + 1, str.length() - i6);
            ...
            if (this.iFieldType != 8 && this.iFieldType != 9) {
                setFieldValue(readWritablePeriod2, this.iFieldType, parseInt(str2, i6, i7));
            } else if (i8 < 0) {
                ...
                if (i12 <= 0) {
                    ...
                    if (i12 >= 3) {
                        ...
                        int parseInt2 = parseInt(str2, i8, i12);
            ...
            int i13 = i6 + i7;
            if (i13 >= 0 && this.iSuffix != null) {
                i13 = this.iSuffix.parse(str2, i13);
            }
            return i13;
        }
