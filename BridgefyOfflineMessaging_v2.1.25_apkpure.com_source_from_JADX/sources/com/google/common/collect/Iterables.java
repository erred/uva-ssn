...
public final class Iterables {
    ...
    public static <T> Iterable<T> concat(Iterable<? extends T> iterable, Iterable<? extends T> iterable2) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m8670of(iterable, iterable2));
    }

    public static <T> Iterable<T> concat(Iterable<? extends T> iterable, Iterable<? extends T> iterable2, Iterable<? extends T> iterable3) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m8671of(iterable, iterable2, iterable3));
    }

    public static <T> Iterable<T> concat(Iterable<? extends T> iterable, Iterable<? extends T> iterable2, Iterable<? extends T> iterable3, Iterable<? extends T> iterable4) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m8672of(iterable, iterable2, iterable3, iterable4));
    }
