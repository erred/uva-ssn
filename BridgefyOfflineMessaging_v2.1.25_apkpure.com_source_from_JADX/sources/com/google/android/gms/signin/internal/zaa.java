...
public final class zaa extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getConnectionResultCode", mo13446id = 2)
    private int zarw;
    @Field(getter = "getRawAuthResolutionIntent", mo13446id = 3)
    private Intent zarx;

    @Constructor
    zaa(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) int i2, @Param(mo13449id = 3) Intent intent) {
        this.zale = i;
        this.zarw = i2;
        this.zarx = intent;
    }
