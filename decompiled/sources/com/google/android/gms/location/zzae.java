...
public final class zzae extends AbstractSafeParcelable {
    ...
    @Field(defaultValue = "", getter = "getJustificationText", mo13446id = 1)
    private final String zzbd;
    @Field(defaultValue = "", getter = "getExperimentId", mo13446id = 2)
    private final String zzbe;
    @Field(defaultValue = "", getter = "getTitleText", mo13446id = 5)
    private final String zzbf;

    @Constructor
    zzae(@Param(mo13449id = 5) String str, @Param(mo13449id = 1) String str2, @Param(mo13449id = 2) String str3) {
        this.zzbf = str;
        this.zzbd = str2;
        this.zzbe = str3;
    }
