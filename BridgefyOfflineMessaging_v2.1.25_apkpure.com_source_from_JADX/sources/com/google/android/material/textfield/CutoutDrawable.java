...
class CutoutDrawable extends MaterialShapeDrawable {
    ...
    private void saveCanvasLayer(Canvas canvas) {
        if (VERSION.SDK_INT >= 21) {
            this.savedLayer = canvas.saveLayer(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (float) canvas.getWidth(), (float) canvas.getHeight(), null);
            return;
        }
        this.savedLayer = canvas.saveLayer(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (float) canvas.getWidth(), (float) canvas.getHeight(), null, 31);
    }
