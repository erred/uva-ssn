...
final class zzbk extends zzbq {
    ...
    /* renamed from: ID */
    private static final String f6672ID = zza.ENCODE.toString();
    ...
    public final zzp zzc(Map<String, zzp> map) {
        ...
        try {
            if ("text".equals(str)) {
                ...
                zzdi.m8600e(valueOf.length() != 0 ? str4.concat(valueOf) : new String(str4));
                return zzgj.zzqq();
            }
            if ("base16".equals(str2)) {
                ...
                zzdi.m8600e(valueOf2.length() != 0 ? str5.concat(valueOf2) : new String(str5));
                return zzgj.zzqq();
            }
            return zzgj.zzj(str3);
        } catch (IllegalArgumentException unused) {
            zzdi.m8600e("Encode: invalid input:");
            return zzgj.zzqq();
        }
    }
}
