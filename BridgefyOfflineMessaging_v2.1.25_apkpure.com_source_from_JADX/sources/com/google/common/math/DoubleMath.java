...
public final class DoubleMath {
    ...
    static /* synthetic */ class C27091 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C27091.<clinit>():void");
        }
    }
    ...
    private static final class MeanAccumulator {
        ...
        /* synthetic */ MeanAccumulator(C27091 r1) {
            this();
        }
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C27091.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    return d + DoubleUtils.copySign(1.0d, d);
                case 6:
                    return Math.rint(d);
                case 7:
                    double rint = Math.rint(d);
                    return Math.abs(d - rint) == 0.5d ? d + DoubleUtils.copySign(0.5d, d) : rint;
                case 8:
    ...
    public static boolean fuzzyEquals(double d, double d2, double d3) {
        ...
        return DoubleUtils.copySign(d - d2, 1.0d) <= d3 || d == d2 || (Double.isNaN(d) && Double.isNaN(d2));
    }
