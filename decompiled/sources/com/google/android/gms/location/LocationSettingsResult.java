...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getLocationSettingsStates", mo13446id = 2)
    ...
    @Constructor
    public LocationSettingsResult(@Param(mo13449id = 1) Status status, @Param(mo13449id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
