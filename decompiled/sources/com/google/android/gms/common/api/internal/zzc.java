...
public final class zzc extends C1062d implements LifecycleFragment {
    private static WeakHashMap<C1071e, WeakReference<zzc>> zzbe = new WeakHashMap<>();
    private Map<String, LifecycleCallback> zzbf = new C0712a();
    /* access modifiers changed from: private */
    public int zzbg = 0;
    /* access modifiers changed from: private */
    public Bundle zzbh;

    public static zzc zza(C1071e eVar) {
        WeakReference weakReference = (WeakReference) zzbe.get(eVar);
        ...
        try {
            zzc zzc2 = (zzc) eVar.getSupportFragmentManager().mo4369a("SupportLifecycleFragmentImpl");
            if (zzc2 == null || zzc2.isRemoving()) {
                zzc2 = new zzc();
                eVar.getSupportFragmentManager().mo4370a().mo4069a((C1062d) zzc2, "SupportLifecycleFragmentImpl").mo4086d();
            }
            zzbe.put(eVar, new WeakReference(zzc2));
            return zzc2;
