...
public class Credential extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getId", mo13446id = 1)
    public final String mId;
    /* access modifiers changed from: private */
    @Field(getter = "getName", mo13446id = 2)
    public final String mName;
    /* access modifiers changed from: private */
    @Field(getter = "getProfilePictureUri", mo13446id = 3)
    public final Uri zzo;
    /* access modifiers changed from: private */
    @Field(getter = "getIdTokens", mo13446id = 4)
    public final List<IdToken> zzp;
    /* access modifiers changed from: private */
    @Field(getter = "getPassword", mo13446id = 5)
    public final String zzq;
    /* access modifiers changed from: private */
    @Field(getter = "getAccountType", mo13446id = 6)
    public final String zzr;
    /* access modifiers changed from: private */
    @Field(getter = "getGivenName", mo13446id = 9)
    public final String zzs;
    /* access modifiers changed from: private */
    @Field(getter = "getFamilyName", mo13446id = 10)
    ...
    @Constructor
    Credential(@Param(mo13449id = 1) String str, @Param(mo13449id = 2) String str2, @Param(mo13449id = 3) Uri uri, @Param(mo13449id = 4) List<IdToken> list, @Param(mo13449id = 5) String str3, @Param(mo13449id = 6) String str4, @Param(mo13449id = 9) String str5, @Param(mo13449id = 10) String str6) {
        List<IdToken> list2;
