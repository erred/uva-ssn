...
public class DateTimeFormatter {
    ...
    public DateTimeFormatter(DateTimePrinter dateTimePrinter, DateTimeParser dateTimeParser) {
        this(DateTimePrinterInternalPrinter.m10983of(dateTimePrinter), DateTimeParserInternalParser.m10982of(dateTimeParser));
    }
    ...
    public DateTimePrinter getPrinter() {
        return InternalPrinterDateTimePrinter.m10985of(this.iPrinter);
    }
    ...
    public DateTimeParser getParser() {
        return InternalParserDateTimeParser.m10984of(this.iParser);
    }
    ...
    private Chronology selectChronology(Chronology chronology) {
        ...
        return this.iZone != null ? chronology2.withZone(this.iZone) : chronology2;
    }
}
