...
public class AvailabilityException extends Exception {
    private final C0712a<zai<?>, ConnectionResult> zaay;

    public AvailabilityException(C0712a<zai<?>, ConnectionResult> aVar) {
        this.zaay = aVar;
    }
    ...
    public final C0712a<zai<?>, ConnectionResult> zaj() {
        return this.zaay;
    }
