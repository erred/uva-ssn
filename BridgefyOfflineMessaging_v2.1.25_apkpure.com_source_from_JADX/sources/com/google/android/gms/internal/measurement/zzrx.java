...
public final class zzrx implements zzsb {
    static final Map<Uri, zzrx> zzbrb = new C0712a();
    private static final String[] zzbrg = {"key", Param.VALUE};
    ...
    public static com.google.android.gms.internal.measurement.zzrx zza(android.content.ContentResolver r3, android.net.Uri r4) {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<android.net.Uri, com.google.android.gms.internal.measurement.zzrx> r1 = zzbrb     // Catch:{ all -> 0x001a }
            ...
            java.util.Map<android.net.Uri, com.google.android.gms.internal.measurement.zzrx> r3 = zzbrb     // Catch:{ SecurityException -> 0x0017 }
