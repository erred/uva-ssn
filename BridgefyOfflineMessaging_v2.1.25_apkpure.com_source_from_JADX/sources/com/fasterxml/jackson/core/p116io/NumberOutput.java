...
public final class NumberOutput {
    ...
    static final String SMALLEST_INT = String.valueOf(C1024a.INVALID_ID);
    ...
    public static int outputInt(int i, char[] cArr, int i2) {
        ...
        if (i < MILLION) {
            if (i >= 1000) {
                int i5 = i / 1000;
                return _full3(i - (i5 * 1000), cArr, _leading3(i5, cArr, i2));
            } else if (i >= 10) {
    ...
    public static int outputLong(long j, char[] cArr, int i) {
        ...
        if (j2 < BILLION_L) {
            i2 = _outputUptoBillion((int) j2, cArr, i);
        } else {
            long j4 = j2 / BILLION_L;
            i2 = _outputFullBillion((int) (j2 - (BILLION_L * j4)), cArr, _leading3((int) j4, cArr, i));
        }
    ...
    public static int outputLong(long j, byte[] bArr, int i) {
        ...
        long j3 = j - (BILLION_L * j2);
        if (j2 < BILLION_L) {
            i2 = _outputUptoBillion((int) j2, bArr, i);
        } else {
            long j4 = j2 / BILLION_L;
            i2 = _outputFullBillion((int) (j2 - (BILLION_L * j4)), bArr, _leading3((int) j4, bArr, i));
        }
