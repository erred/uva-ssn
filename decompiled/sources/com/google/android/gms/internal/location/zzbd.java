...
public final class zzbd extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo13446id = 10)
    private String moduleId;
    @Field(defaultValueUnchecked = "null", mo13446id = 6)
    private String tag;
    @Field(defaultValueUnchecked = "null", mo13446id = 1)
    private LocationRequest zzdg;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_HIDE_FROM_APP_OPS", mo13446id = 7)
    private boolean zzdh;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_FORCE_COARSE_LOCATION", mo13446id = 8)
    private boolean zzdi;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_EXEMPT_FROM_THROTTLE", mo13446id = 9)
    private boolean zzdj;
    private boolean zzdk = true;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_CLIENTS", mo13446id = 5)
    private List<ClientIdentity> zzm;

    @Constructor
    zzbd(@Param(mo13449id = 1) LocationRequest locationRequest, @Param(mo13449id = 5) List<ClientIdentity> list, @Param(mo13449id = 6) String str, @Param(mo13449id = 7) boolean z, @Param(mo13449id = 8) boolean z2, @Param(mo13449id = 9) boolean z3, @Param(mo13449id = 10) String str2) {
