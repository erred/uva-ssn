...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    @Field(getter = "isGpsUsable", mo13446id = 1)
    private final boolean zzbn;
    @Field(getter = "isNetworkLocationUsable", mo13446id = 2)
    private final boolean zzbo;
    @Field(getter = "isBleUsable", mo13446id = 3)
    private final boolean zzbp;
    @Field(getter = "isGpsPresent", mo13446id = 4)
    private final boolean zzbq;
    @Field(getter = "isNetworkLocationPresent", mo13446id = 5)
    private final boolean zzbr;
    @Field(getter = "isBlePresent", mo13446id = 6)
    private final boolean zzbs;

    @Constructor
    public LocationSettingsStates(@Param(mo13449id = 1) boolean z, @Param(mo13449id = 2) boolean z2, @Param(mo13449id = 3) boolean z3, @Param(mo13449id = 4) boolean z4, @Param(mo13449id = 5) boolean z5, @Param(mo13449id = 6) boolean z6) {
        this.zzbn = z;
        this.zzbo = z2;
        this.zzbp = z3;
        this.zzbq = z4;
