...
public class TokenBuffer extends JsonGenerator {
    ...
    protected static final class Parser extends ParserMinimalBase {
        ...
        public JsonLocation getCurrentLocation() {
            return this._location == null ? JsonLocation.f6134NA : this._location;
        }
        ...
        public BigDecimal getDecimalValue() throws IOException {
            ...
            int i = C19881.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[getNumberType().ordinal()];
            if (i != 5) {
                switch (i) {
                    case 1:
                        break;
    ...
    public TokenBuffer deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        JsonToken nextToken;
        if (jsonParser.getCurrentTokenId() != JsonToken.FIELD_NAME.mo8239id()) {
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int i = C19881.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()];
        if (i == 1) {
            writeStartObject();
    ...
    public final void _appendRaw(int i, Object obj) {
        Segment segment;
        if (this._hasNativeId) {
            segment = this._last.appendRaw(this._appendAt, i, obj, this._objectId, this._typeId);
        } else {
            segment = this._last.appendRaw(this._appendAt, i, obj);
        }
        if (segment == null) {
            this._appendAt++;
            return;
