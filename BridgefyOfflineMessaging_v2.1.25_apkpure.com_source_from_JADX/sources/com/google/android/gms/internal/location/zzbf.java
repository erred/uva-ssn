...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo13446id = 4)
    private PendingIntent zzbv;
    @Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", mo13446id = 1)
    private int zzcg;
    @Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo13446id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @Field(defaultValueUnchecked = "null", mo13446id = 2)
    private zzbd zzdl;
    @Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", mo13446id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", mo13446id = 5, type = "android.os.IBinder")
    private zzu zzdn;

    @Constructor
    zzbf(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) zzbd zzbd, @Param(mo13449id = 3) IBinder iBinder, @Param(mo13449id = 4) PendingIntent pendingIntent, @Param(mo13449id = 5) IBinder iBinder2, @Param(mo13449id = 6) IBinder iBinder3) {
        this.zzcg = i;
        this.zzdl = zzbd;
        zzaj zzaj = null;
