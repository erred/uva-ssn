...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @Field(getter = "getRequestId", mo13446id = 1)
    private final String zzad;
    @Field(getter = "getTransitionTypes", mo13446id = 7)
    private final int zzae;
    @Field(getter = "getType", mo13446id = 3)
    private final short zzag;
    @Field(getter = "getLatitude", mo13446id = 4)
    private final double zzah;
    @Field(getter = "getLongitude", mo13446id = 5)
    private final double zzai;
    @Field(getter = "getRadius", mo13446id = 6)
    private final float zzaj;
    @Field(defaultValue = "0", getter = "getNotificationResponsiveness", mo13446id = 8)
    private final int zzak;
    @Field(defaultValue = "-1", getter = "getLoiteringDelay", mo13446id = 9)
    private final int zzal;
    @Field(getter = "getExpirationTime", mo13446id = 2)
    private final long zzdo;

    @Constructor
    public zzbh(@Param(mo13449id = 1) String str, @Param(mo13449id = 7) int i, @Param(mo13449id = 3) short s, @Param(mo13449id = 4) double d, @Param(mo13449id = 5) double d2, @Param(mo13449id = 6) float f, @Param(mo13449id = 2) long j, @Param(mo13449id = 8) int i2, @Param(mo13449id = 9) int i3) {
