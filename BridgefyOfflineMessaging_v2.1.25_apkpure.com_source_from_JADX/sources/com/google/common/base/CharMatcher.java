...
public abstract class CharMatcher implements Predicate<Character> {
    public static final CharMatcher ANY = new FastMatcher("CharMatcher.ANY") {
        ...
        /* renamed from: or */
        public CharMatcher mo21322or(CharMatcher charMatcher) {
    ...
    public static final CharMatcher JAVA_ISO_CONTROL = inRange(0, 31).mo21322or(inRange(Ascii.MAX, 159)).withToString("CharMatcher.JAVA_ISO_CONTROL");
    ...
    private static class C2348Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C2348Or(CharMatcher charMatcher, CharMatcher charMatcher2, String str) {
            super(str);
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }

        C2348Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            StringBuilder sb = new StringBuilder();
        ...
        /* access modifiers changed from: 0000 */
        public CharMatcher withToString(String str) {
            return new C2348Or(this.first, this.second, str);
        }
    }
    ...
    /* renamed from: is */
    public static CharMatcher m8636is(final char c) {
        StringBuilder sb = new StringBuilder();
        ...
        return new FastMatcher(sb.toString()) {
            ...
            /* renamed from: or */
            public CharMatcher mo21322or(CharMatcher charMatcher) {
                return charMatcher.matches(c) ? charMatcher : super.mo21322or(charMatcher);
            }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        switch (charSequence.length()) {
            case 0:
                return NONE;
            case 1:
                return m8636is(charSequence.charAt(0));
            case 2:
    ...
    /* renamed from: or */
    public CharMatcher mo21322or(CharMatcher charMatcher) {
        return new C2348Or(this, (CharMatcher) Preconditions.checkNotNull(charMatcher));
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        switch (i) {
            case 0:
                return NONE;
            case 1:
                return m8636is((char) bitSet.nextSetBit(0));
            case 2:
