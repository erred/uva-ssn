...
public class SupportStreetViewPanoramaFragment extends C1062d {
    private final zzb zzch = new zzb(this);

    @VisibleForTesting
    static class zza implements StreetViewLifecycleDelegate {
        private final C1062d fragment;
        private final IStreetViewPanoramaFragmentDelegate zzbt;

        public zza(C1062d dVar, IStreetViewPanoramaFragmentDelegate iStreetViewPanoramaFragmentDelegate) {
            this.zzbt = (IStreetViewPanoramaFragmentDelegate) Preconditions.checkNotNull(iStreetViewPanoramaFragmentDelegate);
            this.fragment = (C1062d) Preconditions.checkNotNull(dVar);
        }
        ...
        private final void zzc() {
            if (!(this.zzbd == null || this.zzbc == null || getDelegate() != null)) {
                try {
                    ...
                    this.zzbc.onDelegateCreated(new zza(this.fragment, zzbz.zza((Context) this.zzbd).zzd(ObjectWrapper.wrap(this.zzbd))));
