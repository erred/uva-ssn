...
public final class zaj extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo13446id = 2)
    private final ConnectionResult zadh;
    @VersionField(mo13452id = 1)
    private final int zale;
    @Field(getter = "getResolveAccountResponse", mo13446id = 3)
    private final ResolveAccountResponse zasb;

    @Constructor
    zaj(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) ConnectionResult connectionResult, @Param(mo13449id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zale = i;
