...
import p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.CollectionResponseBgfyKey;

/* renamed from: me.bridgefy.backend.v3.bgfyKeyApi.BgfyKeyApi */
public class BgfyKeyApi extends AbstractGoogleJsonClient {
    public static final String DEFAULT_BASE_URL = "https://bionic-armando.appspot.com/_ah/api/bgfyKeyApi/v3/";
    public static final String DEFAULT_BATCH_PATH = "batch";
    public static final String DEFAULT_ROOT_URL = "https://bionic-armando.appspot.com/_ah/api/";
    public static final String DEFAULT_SERVICE_PATH = "bgfyKeyApi/v3/";

    /* renamed from: me.bridgefy.backend.v3.bgfyKeyApi.BgfyKeyApi$BgfyKey */
    public class BgfyKey {

        /* renamed from: me.bridgefy.backend.v3.bgfyKeyApi.BgfyKeyApi$BgfyKey$InsertKey */
        public class InsertKey extends BgfyKeyApiRequest<p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey> {
            private static final String REST_PATH = "bgfykey";

            protected InsertKey(p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey bgfyKey) {
                super(BgfyKeyApi.this, HttpMethods.POST, REST_PATH, bgfyKey, p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey.class);
            }
        ...
        /* renamed from: me.bridgefy.backend.v3.bgfyKeyApi.BgfyKeyApi$BgfyKey$ListKeys */
        ...
        /* renamed from: me.bridgefy.backend.v3.bgfyKeyApi.BgfyKeyApi$BgfyKey$RemoveKey */
        ...
        /* renamed from: me.bridgefy.backend.v3.bgfyKeyApi.BgfyKeyApi$BgfyKey$UpdateKey */
        public class UpdateKey extends BgfyKeyApiRequest<p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey> {
            private static final String REST_PATH = "bgfyKey/{owner}";
            @Key
            private String owner;

            protected UpdateKey(String str, p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey bgfyKey) {
                super(BgfyKeyApi.this, HttpMethods.PUT, REST_PATH, bgfyKey, p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey.class);
                this.owner = (String) Preconditions.checkNotNull(str, "Required parameter owner must be specified.");
            }
        ...
        public InsertKey insertKey(p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey bgfyKey) throws IOException {
        ...
        public UpdateKey updateKey(String str, p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey bgfyKey) throws IOException {
    ...
    /* renamed from: me.bridgefy.backend.v3.bgfyKeyApi.BgfyKeyApi$Builder */
    ...
    /* renamed from: me.bridgefy.backend.v3.bgfyKeyApi.BgfyKeyApi$Get */
    public class Get extends BgfyKeyApiRequest<p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey> {
        private static final String REST_PATH = "bgfyKey/{owner}";
        @Key
        private String owner;

        protected Get(String str) {
            super(BgfyKeyApi.this, HttpMethods.GET, REST_PATH, null, p140me.bridgefy.backend.p143v3.bgfyKeyApi.model.BgfyKey.class);
            this.owner = (String) Preconditions.checkNotNull(str, "Required parameter owner must be specified.");
        }
