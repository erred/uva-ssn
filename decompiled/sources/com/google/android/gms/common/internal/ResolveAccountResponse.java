...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo13446id = 3)
    private ConnectionResult zadh;
    @Field(getter = "getSaveDefaultAccount", mo13446id = 4)
    private boolean zagf;
    @VersionField(mo13452id = 1)
    private final int zale;
    @Field(mo13446id = 2)
    private IBinder zanw;
    @Field(getter = "isFromCrossClientAuth", mo13446id = 5)
    private boolean zapb;

    @Constructor
    ResolveAccountResponse(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) IBinder iBinder, @Param(mo13449id = 3) ConnectionResult connectionResult, @Param(mo13449id = 4) boolean z, @Param(mo13449id = 5) boolean z2) {
        this.zale = i;
        this.zanw = iBinder;
