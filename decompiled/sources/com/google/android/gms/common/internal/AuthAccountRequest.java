...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(mo13446id = 6, type = "android.accounts.Account")
    private Account zax;

    @Constructor
    AuthAccountRequest(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) IBinder iBinder, @Param(mo13449id = 3) Scope[] scopeArr, @Param(mo13449id = 4) Integer num, @Param(mo13449id = 5) Integer num2, @Param(mo13449id = 6) Account account) {
        this.zale = i;
        this.zanw = iBinder;
        this.zanx = scopeArr;
        this.zany = num;
