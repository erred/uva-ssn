...
public final class PolygonOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "isClickable", mo13446id = 10)
    private boolean zzct;
    @Field(getter = "getStrokePattern", mo13446id = 12)
    private List<PatternItem> zzcu;
    @Field(getter = "getPoints", mo13446id = 2)
    private final List<LatLng> zzdw;
    @Field(getter = "getHolesForParcel", mo13446id = 3, type = "java.util.List")
    private final List<List<LatLng>> zzdx;
    @Field(getter = "isGeodesic", mo13446id = 9)
    private boolean zzdy;
    @Field(getter = "getStrokeJointType", mo13446id = 11)
    private int zzdz;
    ...
    @Constructor
    PolygonOptions(@Param(mo13449id = 2) List<LatLng> list, @Param(mo13449id = 3) List list2, @Param(mo13449id = 4) float f, @Param(mo13449id = 5) int i, @Param(mo13449id = 6) int i2, @Param(mo13449id = 7) float f2, @Param(mo13449id = 8) boolean z, @Param(mo13449id = 9) boolean z2, @Param(mo13449id = 10) boolean z3, @Param(mo13449id = 11) int i3, @Param(mo13449id = 12) List<PatternItem> list3) {
        this.zzcq = 10.0f;
        this.strokeColor = -16777216;
        this.fillColor = 0;
        this.zzcr = BitmapDescriptorFactory.HUE_RED;
