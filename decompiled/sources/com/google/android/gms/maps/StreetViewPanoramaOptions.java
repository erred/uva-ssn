...
public final class StreetViewPanoramaOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getPanoramaId", mo13446id = 3)
    private String panoId;
    @Field(getter = "getPosition", mo13446id = 4)
    private LatLng position;
    @Field(getter = "getUseViewLifecycleInFragmentForParcel", mo13446id = 10, type = "byte")
    private Boolean zzak;
    @Field(getter = "getZoomGesturesEnabledForParcel", mo13446id = 7, type = "byte")
    private Boolean zzap = Boolean.valueOf(true);
    @Field(getter = "getStreetViewPanoramaCamera", mo13446id = 2)
    private StreetViewPanoramaCamera zzbw;
    @Field(getter = "getRadius", mo13446id = 5)
    private Integer zzbx;
    @Field(getter = "getUserNavigationEnabledForParcel", mo13446id = 6, type = "byte")
    private Boolean zzby = Boolean.valueOf(true);
    @Field(getter = "getPanningGesturesEnabledForParcel", mo13446id = 8, type = "byte")
    private Boolean zzbz = Boolean.valueOf(true);
    @Field(getter = "getStreetNamesEnabledForParcel", mo13446id = 9, type = "byte")
    private Boolean zzca = Boolean.valueOf(true);
    @Field(getter = "getSource", mo13446id = 11)
    ...
    @Constructor
    StreetViewPanoramaOptions(@Param(mo13449id = 2) StreetViewPanoramaCamera streetViewPanoramaCamera, @Param(mo13449id = 3) String str, @Param(mo13449id = 4) LatLng latLng, @Param(mo13449id = 5) Integer num, @Param(mo13449id = 6) byte b, @Param(mo13449id = 7) byte b2, @Param(mo13449id = 8) byte b3, @Param(mo13449id = 9) byte b4, @Param(mo13449id = 10) byte b5, @Param(mo13449id = 11) StreetViewSource streetViewSource) {
