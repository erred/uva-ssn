    ...
    public Entry<Object, Object> deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        if (currentToken == JsonToken.FIELD_NAME) {
            ...
            if (nextToken == JsonToken.FIELD_NAME) {
                StringBuilder sb = new StringBuilder();
                sb.append("Problem binding JSON into Map.Entry: more than one entry in JSON (second field: '");
                sb.append(jsonParser.getCurrentName());
                sb.append("')");
                deserializationContext.reportMappingException(sb.toString(), new Object[0]);
            } else {
                StringBuilder sb2 = new StringBuilder();
                sb2.append("Problem binding JSON into Map.Entry: unexpected content after JSON Object entry: ");
                sb2.append(nextToken);
                deserializationContext.reportMappingException(sb2.toString(), new Object[0]);
            }
            return null;
