...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getSessionId", mo13446id = 3)
    private final int zaoz;
    @Field(getter = "getSignInAccountHint", mo13446id = 4)
    private final GoogleSignInAccount zapa;
    @Field(getter = "getAccount", mo13446id = 2)
    private final Account zax;

    @Constructor
    ResolveAccountRequest(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) Account account, @Param(mo13449id = 3) int i2, @Param(mo13449id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zale = i;
        this.zax = account;
        this.zaoz = i2;
