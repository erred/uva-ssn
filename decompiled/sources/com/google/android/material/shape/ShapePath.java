...
public class ShapePath {
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, (float) Math.hypot((double) (this.operation.f6715y - this.startY), (double) (this.operation.f6714x - this.startX)), BitmapDescriptorFactory.HUE_RED);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f6715y - this.startY) / (this.operation.f6714x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f6714x, this.f6715y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f6714x = f;
        pathLineOperation.f6715y = f2;
    ...
    private void addConnectingShadowIfNecessary(float f) {
        if (this.currentShadowAngle != f) {
            float f2 = ((f - this.currentShadowAngle) + 360.0f) % 360.0f;
            if (f2 <= 180.0f) {
                PathArcOperation pathArcOperation = new PathArcOperation(this.endX, this.endY, this.endX, this.endY);
