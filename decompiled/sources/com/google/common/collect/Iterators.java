...
public final class Iterators {
    ...
    public static boolean removeAll(Iterator<?> it, Collection<?> collection) {
        return removeIf(it, Predicates.m8648in(collection));
    }
    ...
    public static boolean retainAll(Iterator<?> it, Collection<?> collection) {
        return removeIf(it, Predicates.not(Predicates.m8648in(collection)));
    }
    ...
    public static <T> Iterator<T> concat(Iterator<? extends T> it, Iterator<? extends T> it2) {
        return concat((Iterator<? extends Iterator<? extends T>>) ImmutableList.m8670of(it, it2).iterator());
    }

    public static <T> Iterator<T> concat(Iterator<? extends T> it, Iterator<? extends T> it2, Iterator<? extends T> it3) {
        return concat((Iterator<? extends Iterator<? extends T>>) ImmutableList.m8671of(it, it2, it3).iterator());
    }

    public static <T> Iterator<T> concat(Iterator<? extends T> it, Iterator<? extends T> it2, Iterator<? extends T> it3, Iterator<? extends T> it4) {
        return concat((Iterator<? extends Iterator<? extends T>>) ImmutableList.m8672of(it, it2, it3, it4).iterator());
    }
    ...
    public static <T> Optional<T> tryFind(Iterator<T> it, Predicate<? super T> predicate) {
        ...
        return filter.hasNext() ? Optional.m8644of(filter.next()) : Optional.absent();
    }
