...
public interface zzaj extends IInterface {
    List<zzfv> zza(zzk zzk, boolean z) throws RemoteException;

    List<zzo> zza(String str, String str2, zzk zzk) throws RemoteException;

    List<zzfv> zza(String str, String str2, String str3, boolean z) throws RemoteException;

    List<zzfv> zza(String str, String str2, boolean z, zzk zzk) throws RemoteException;
    ...
    void zza(zzfv zzfv, zzk zzk) throws RemoteException;
