...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getLocationRequests", mo13446id = 1)
    private final List<LocationRequest> zzbg;
    @Field(defaultValue = "false", getter = "alwaysShow", mo13446id = 2)
    private final boolean zzbh;
    @Field(getter = "needBle", mo13446id = 3)
    private final boolean zzbi;
    @Field(getter = "getConfiguration", mo13446id = 5)
    private zzae zzbj;
    ...
    @Constructor
    LocationSettingsRequest(@Param(mo13449id = 1) List<LocationRequest> list, @Param(mo13449id = 2) boolean z, @Param(mo13449id = 3) boolean z2, @Param(mo13449id = 5) zzae zzae) {
        this.zzbg = list;
        this.zzbh = z;
        this.zzbi = z2;
        this.zzbj = zzae;
