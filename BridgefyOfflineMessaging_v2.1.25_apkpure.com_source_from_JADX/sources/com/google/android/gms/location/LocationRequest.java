...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_PRIORITY", mo13446id = 1)
    private int priority;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPIRE_AT", mo13446id = 5)
    private long zzaf;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_INTERVAL", mo13446id = 2)
    private long zzaw;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_FASTEST_INTERVAL", mo13446id = 3)
    private long zzax;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPLICIT_FASTEST_INTERVAL", mo13446id = 4)
    private boolean zzay;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_SMALLEST_DISPLACEMENT", mo13446id = 7)
    private float zzaz;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_MAX_WAIT_TIME", mo13446id = 8)
    private long zzba;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_NUM_UPDATES", mo13446id = 6)
    private int zzx;
    ...
    public LocationRequest() {
        ...
        this.zzx = BaseClientBuilder.API_PRIORITY_OTHER;
        this.zzaz = BitmapDescriptorFactory.HUE_RED;
        this.zzba = 0;
    }

    @Constructor
    LocationRequest(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) long j, @Param(mo13449id = 3) long j2, @Param(mo13449id = 4) boolean z, @Param(mo13449id = 5) long j3, @Param(mo13449id = 6) int i2, @Param(mo13449id = 7) float f, @Param(mo13449id = 8) long j4) {
        this.priority = i;
        this.zzaw = j;
        this.zzax = j2;
        this.zzay = z;
