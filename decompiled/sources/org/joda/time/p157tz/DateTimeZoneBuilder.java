...
public class DateTimeZoneBuilder {
    ...
    private static final class DSTZone extends DateTimeZone {
        ...
        public long nextTransition(long r9) {
            ...
            L_0x0031:
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: org.joda.time.p157tz.DateTimeZoneBuilder.DSTZone.nextTransition(long):long");
        }
        ...
        public long previousTransition(long r11) {
            ...
            L_0x0033:
                ...
                return r11
            */
            throw new UnsupportedOperationException("Method not decompiled: org.joda.time.p157tz.DateTimeZoneBuilder.DSTZone.previousTransition(long):long");
        }
    ...
    private static final class PrecalculatedZone extends DateTimeZone {
        ...
        static PrecalculatedZone create(String str, boolean z, ArrayList<Transition> arrayList, DSTZone dSTZone) {
            ...
            if (size != 0) {
                ...
                while (i < strArr.length - 1) {
                    ...
                    if (i4 != 0 && j3 == j4 && str3.equals(str4) && period.getYears() == 0 && period.getMonths() > 4 && period.getMonths() < 8 && str3.equals(strArr3[2]) && str3.equals(strArr3[4])) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!getID().equals(precalculatedZone.getID()) || !Arrays.equals(this.iTransitions, precalculatedZone.iTransitions) || !Arrays.equals(this.iNameKeys, precalculatedZone.iNameKeys) || !Arrays.equals(this.iWallOffsets, precalculatedZone.iWallOffsets) || !Arrays.equals(this.iStandardOffsets, precalculatedZone.iStandardOffsets) || (this.iTailZone != null ? !this.iTailZone.equals(precalculatedZone.iTailZone) : precalculatedZone.iTailZone != null)) {
                z = false;
            }
            return z;
        }
    ...
    private static final class RuleSet {
        ...
        RuleSet() {
            ...
            this.iUpperYear = BaseClientBuilder.API_PRIORITY_OTHER;
        }
        ...
        public Transition firstTransition(long j) {
            if (this.iInitialNameKey != null) {
                Transition transition = new Transition(j, this.iInitialNameKey, this.iStandardOffset + this.iInitialSaveMillis, this.iStandardOffset);
                return transition;
            }
            ...
            while (true) {
                ...
                if (i2 == 0) {
                    ...
                    if (transition2 == null) {
                        Transition transition3 = new Transition(j, nextTransition.getNameKey(), this.iStandardOffset, this.iStandardOffset);
    ...
    public DateTimeZoneBuilder addCutover(int i, char c, int i2, int i3, int i4, boolean z, int i5) {
        if (this.iRuleSets.size() > 0) {
            ...
            ((RuleSet) this.iRuleSets.get(this.iRuleSets.size() - 1)).setUpperLimit(i, ofYear);
        }
    ...
    private RuleSet getLastRuleSet() {
        if (this.iRuleSets.size() == 0) {
            addCutover(C1024a.INVALID_ID, 'w', 1, 1, 0, false, 0);
        }
