...
import com.google.firebase.components.Component.C28291;
...
public class FirebaseApp {
    static final Map<String, FirebaseApp> zza = new C0712a();
    ...
    private FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        List zza2 = C28291.zza(context).zza();
        this.zzl = new zzf(zzh, zza2, Component.m8764of(context, Context.class, new Class[0]), Component.m8764of(this, FirebaseApp.class, new Class[0]), Component.m8764of(firebaseOptions, FirebaseOptions.class, new Class[0]));
    ...
    /* access modifiers changed from: private */
    public void zze() {
        boolean c = C0875a.m3249c(this.zzi);
        if (c) {
            zzc.zza(this.zzi);
        } else {
