...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getTag", mo13446id = 3)
    private final String tag;
    @VersionField(mo13452id = 1)
    private final int versionCode;
    @Field(getter = "getPlaceId", mo13446id = 2)
    private final String zza;
    @Field(getter = "getSource", mo13446id = 4)
    private final String zzb;

    @Constructor
    PlaceReport(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) String str, @Param(mo13449id = 3) String str2, @Param(mo13449id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;
