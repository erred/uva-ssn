...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @Field(getter = "getHeight", mo13446id = 4)
    private final int zane;
    @Field(getter = "getUrl", mo13446id = 2)
    private final Uri zanf;

    @Constructor
    WebImage(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) Uri uri, @Param(mo13449id = 3) int i2, @Param(mo13449id = 4) int i3) {
        this.zale = i;
        this.zanf = uri;
        this.zand = i2;
        this.zane = i3;
