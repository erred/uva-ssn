...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Deprecated
    private int zzas;
    @Field(defaultValueUnchecked = "0", mo13446id = 3)
    private long zzat;
    @Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo13446id = 4)
    private int zzau;
    @Field(mo13446id = 5)
    private zzaj[] zzav;

    @Constructor
    LocationAvailability(@Param(mo13449id = 4) int i, @Param(mo13449id = 1) int i2, @Param(mo13449id = 2) int i3, @Param(mo13449id = 3) long j, @Param(mo13449id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;
