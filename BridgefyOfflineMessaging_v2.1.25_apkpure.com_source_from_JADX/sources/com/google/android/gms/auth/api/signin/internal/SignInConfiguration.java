...
public final class SignInConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getConsumerPkgName", mo13446id = 2)
    private final String zzbr;
    @Field(getter = "getGoogleConfig", mo13446id = 5)
    private GoogleSignInOptions zzbs;

    @Constructor
    public SignInConfiguration(@Param(mo13449id = 2) String str, @Param(mo13449id = 5) GoogleSignInOptions googleSignInOptions) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!this.zzbr.equals(signInConfiguration.zzbr) || (this.zzbs != null ? !this.zzbs.equals(signInConfiguration.zzbs) : signInConfiguration.zzbs != null)) {
            return false;
        }
        return true;
    }
