...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo13446id = 1)
    private final int zzh;
    @Field(getter = "getPendingIntent", mo13446id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getStatusMessage", mo13446id = 2)
    private final String zzj;

    @Constructor
    @KeepForSdk
    Status(@Param(mo13449id = 1000) int i, @Param(mo13449id = 1) int i2, @Param(mo13449id = 2) String str, @Param(mo13449id = 3) PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
