...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getTag", mo13446id = 2)
    private final String tag;
    @Field(getter = "getActivityTransitions", mo13446id = 1)
    private final List<ActivityTransition> zzl;
    @Field(getter = "getClients", mo13446id = 3)
    ...
    @Constructor
    public ActivityTransitionRequest(@Param(mo13449id = 1) List<ActivityTransition> list, @Param(mo13449id = 2) String str, @Param(mo13449id = 3) List<ClientIdentity> list2) {
