...
import p140me.bridgefy.backend.p142v2.bgfyUserApi.model.CollectionResponseBgfyUser;
import p140me.bridgefy.backend.p142v2.bgfyUserApi.model.EndpointPhoneListContainer;

/* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi */
public class BgfyUserApi extends AbstractGoogleJsonClient {
    public static final String DEFAULT_BASE_URL = "https://bionic-armando.appspot.com/_ah/api/bgfyUserApi/v2/";
    public static final String DEFAULT_BATCH_PATH = "batch";
    public static final String DEFAULT_ROOT_URL = "https://bionic-armando.appspot.com/_ah/api/";
    public static final String DEFAULT_SERVICE_PATH = "bgfyUserApi/v2/";

    /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$BgfyUser */
    public class BgfyUser {

        /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$BgfyUser$BlockUser */
        ...
        /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$BgfyUser$GetUserByAuthToken */
        public class GetUserByAuthToken extends BgfyUserApiRequest<p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser> {
            private static final String REST_PATH = "getUserByToken/{authToken}";
            @Key
            private String authToken;

            protected GetUserByAuthToken(String str) {
                super(BgfyUserApi.this, HttpMethods.GET, REST_PATH, null, p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser.class);
                this.authToken = (String) Preconditions.checkNotNull(str, "Required parameter authToken must be specified.");
            }
            ...
            public GetUserByAuthToken setAlt(String str) {
                return (GetUserByAuthToken) super.setAlt(str);
            }

            public GetUserByAuthToken setFields(String str) {
                return (GetUserByAuthToken) super.setFields(str);
            }

            public GetUserByAuthToken setKey(String str) {
                return (GetUserByAuthToken) super.setKey(str);
            }

            public GetUserByAuthToken setOauthToken(String str) {
                return (GetUserByAuthToken) super.setOauthToken(str);
            }

            public GetUserByAuthToken setPrettyPrint(Boolean bool) {
                return (GetUserByAuthToken) super.setPrettyPrint(bool);
            }

            public GetUserByAuthToken setQuotaUser(String str) {
                return (GetUserByAuthToken) super.setQuotaUser(str);
            }

            public GetUserByAuthToken setUserIp(String str) {
                return (GetUserByAuthToken) super.setUserIp(str);
            }
            ...
            public GetUserByAuthToken setAuthToken(String str) {
                this.authToken = str;
                return this;
            }

            public GetUserByAuthToken set(String str, Object obj) {
                return (GetUserByAuthToken) super.set(str, obj);
            }
        }

        /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$BgfyUser$GetUserById */
        public class GetUserById extends BgfyUserApiRequest<p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser> {
        ...
        /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$BgfyUser$InsertUser */
        public class InsertUser extends BgfyUserApiRequest<p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser> {
            private static final String REST_PATH = "bgfyuser";

            protected InsertUser(p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser bgfyUser) {
                super(BgfyUserApi.this, HttpMethods.POST, REST_PATH, bgfyUser, p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser.class);
            }
        ...
        /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$BgfyUser$UnblockUser */
        ...
        /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$BgfyUser$UpdateUser */
        public class UpdateUser extends BgfyUserApiRequest<p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser> {
            private static final String REST_PATH = "bgfyuser";

            protected UpdateUser(p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser bgfyUser) {
                super(BgfyUserApi.this, HttpMethods.PUT, REST_PATH, bgfyUser, p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser.class);
            }
        ...
        /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$BgfyUser$UpdateUserBluetoothAddress */
        ...
        public GetUserByAuthToken getUserByAuthToken(String str) throws IOException {
            GetUserByAuthToken getUserByAuthToken = new GetUserByAuthToken(str);
            BgfyUserApi.this.initialize(getUserByAuthToken);
        ...
        public InsertUser insertUser(p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser bgfyUser) throws IOException {
        ...
        public UpdateUser updateUser(p140me.bridgefy.backend.p142v2.bgfyUserApi.model.BgfyUser bgfyUser) throws IOException {
    ...
    /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$Builder */
    ...
    /* renamed from: me.bridgefy.backend.v2.bgfyUserApi.BgfyUserApi$Contacts */
