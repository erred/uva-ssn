...
public class MaterialCardView extends C0742a {
    private static final int DEF_STYLE_RES = C2167R.style.Widget_MaterialComponents_CardView;
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2167R.attr.materialCardViewStyle);
    }
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2167R.styleable.MaterialCardView, i, DEF_STYLE_RES, new int[0]);
