...
public final class Minutes extends BaseSingleFieldPeriod {
    public static final Minutes MAX_VALUE = new Minutes(BaseClientBuilder.API_PRIORITY_OTHER);
    public static final Minutes MIN_VALUE = new Minutes(C1024a.INVALID_ID);
