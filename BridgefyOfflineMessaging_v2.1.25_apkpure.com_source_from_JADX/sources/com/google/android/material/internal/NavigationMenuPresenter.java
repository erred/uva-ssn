...
import androidx.recyclerview.widget.C1320j;
...
public class NavigationMenuPresenter implements C0549o {
    private static final String STATE_ADAPTER = "android:menu:adapter";
    private static final String STATE_HEADER = "android:menu:header";
    private static final String STATE_HIERARCHY = "android:menu:list";
    NavigationMenuAdapter adapter;
    private C0550a callback;
    ...
    final OnClickListener onClickListener = new OnClickListener() {
        public void onClick(View view) {
            ...
            C0537j itemData = navigationMenuItemView.getItemData();
    ...
    private class NavigationMenuAdapter extends C1243a<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            switch (getItemViewType(i)) {
                case 0:
                    ...
                    C0962r.m3557a((View) navigationMenuItemView, NavigationMenuPresenter.this.itemBackground != null ? NavigationMenuPresenter.this.itemBackground.getConstantState().newDrawable() : null);
        ...
        private void prepareMenuItems() {
            if (!this.updateSuspended) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    C0537j jVar = (C0537j) NavigationMenuPresenter.this.menu.getVisibleItems().get(i3);
                    if (jVar.isChecked()) {
                        setCheckedItem(jVar);
                    }
                    if (jVar.isCheckable()) {
                    ...
                    if (jVar.hasSubMenu()) {
                        ...
                        if (subMenu.hasVisibleItems()) {
                            ...
                            for (int i4 = 0; i4 < size3; i4++) {
                                C0537j jVar2 = (C0537j) subMenu.getItem(i4);
                                if (jVar2.isVisible()) {
        ...
        public void setCheckedItem(C0537j jVar) {
        ...
        public Bundle createInstanceState() {
            ...
            for (int i = 0; i < size; i++) {
                NavigationMenuItem navigationMenuItem = (NavigationMenuItem) this.items.get(i);
                if (navigationMenuItem instanceof NavigationMenuTextItem) {
                    C0537j menuItem = ((NavigationMenuTextItem) navigationMenuItem).getMenuItem();
            ...
            if (sparseParcelableArray != null) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if (navigationMenuItem2 instanceof NavigationMenuTextItem) {
                        C0537j menuItem2 = ((NavigationMenuTextItem) navigationMenuItem2).getMenuItem();
                        if (menuItem2 != null) {
    ...
    private static class NavigationMenuTextItem implements NavigationMenuItem {
        private final C0537j menuItem;
        boolean needsEmptyIcon;

        NavigationMenuTextItem(C0537j jVar) {
            this.menuItem = jVar;
        }

        public C0537j getMenuItem() {
            return this.menuItem;
        }
    }

    private class NavigationMenuViewAccessibilityDelegate extends C1320j {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, C0935b bVar) {
            ...
            bVar.mo3674a((Object) C0937b.m3469a(NavigationMenuPresenter.this.adapter.getRowCount(), 0, false));
        }
    }

    private static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, OnClickListener onClickListener) {
            super(layoutInflater.inflate(C2167R.layout.design_navigation_item, viewGroup, false));
    ...
    private static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C2167R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }

    private static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C2167R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }

    private static abstract class ViewHolder extends C1277x {
    ...
    public void initForMenu(Context context, C0533h hVar) {
        ...
        this.menu = hVar;
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(C2167R.dimen.design_navigation_separator_vertical_padding);
    }

    public C0551p getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            this.menuView = (NavigationMenuView) this.layoutInflater.inflate(C2167R.layout.design_navigation_menu, viewGroup, false);
            this.menuView.setAccessibilityDelegateCompat(new NavigationMenuViewAccessibilityDelegate(this.menuView));
            if (this.adapter == null) {
                this.adapter = new NavigationMenuAdapter();
            }
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C2167R.layout.design_navigation_item_header, this.menuView, false);
    ...
    public void dispatchApplyWindowInsets(C0976z zVar) {
        int b = zVar.mo3778b();
        ...
        C0962r.m3568b((View) this.headerLayout, zVar);
    }
}
