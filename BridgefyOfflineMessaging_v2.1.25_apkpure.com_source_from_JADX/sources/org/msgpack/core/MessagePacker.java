...
public class MessagePacker implements Closeable, Flushable {
            ...
            if (str.length() < 256) {
                ...
                if (encodeStringToBufferAt >= 0) {
                    if (this.str8FormatSupport && encodeStringToBufferAt < 256) {
                        ...
                        this.position = i3 + 1;
                        messageBuffer3.putByte(i3, Code.STR16);
                ...
                if (encodeStringToBufferAt2 >= 0) {
                    if (encodeStringToBufferAt2 < 65536) {
                    ...
                    } else if (((long) encodeStringToBufferAt2) < 4294967296L) {
                        ...
                        this.position = i5 + 1;
                        messageBuffer5.putByte(i5, Code.STR32);
    ...
    public MessagePacker packValue(C3767x xVar) throws IOException {
        xVar.mo31956a(this);
        return this;
    }
