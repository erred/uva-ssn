...
public class OffsetDateTimeField extends DecoratedDateTimeField {
    ...
    public OffsetDateTimeField(DateTimeField dateTimeField, int i) {
        this(dateTimeField, dateTimeField == null ? null : dateTimeField.getType(), i, C1024a.INVALID_ID, BaseClientBuilder.API_PRIORITY_OTHER);
    }

    public OffsetDateTimeField(DateTimeField dateTimeField, DateTimeFieldType dateTimeFieldType, int i) {
        this(dateTimeField, dateTimeFieldType, i, C1024a.INVALID_ID, BaseClientBuilder.API_PRIORITY_OTHER);
    }
