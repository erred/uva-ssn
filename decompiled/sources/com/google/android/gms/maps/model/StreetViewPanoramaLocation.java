...
public class StreetViewPanoramaLocation extends AbstractSafeParcelable {
    ...
    @Constructor
    public StreetViewPanoramaLocation(@Param(mo13449id = 2) StreetViewPanoramaLink[] streetViewPanoramaLinkArr, @Param(mo13449id = 3) LatLng latLng, @Param(mo13449id = 4) String str) {
