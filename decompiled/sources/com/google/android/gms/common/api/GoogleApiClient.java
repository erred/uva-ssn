...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            this.zabx = new C0712a();
            this.zaby = new C0712a();
            this.zaca = -1;
        ...
        public final Builder enableAutoManage(C1071e eVar, int i, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        public final Builder enableAutoManage(C1071e eVar, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        public final GoogleApiClient build() {
            ...
            zaaw zaaw = new zaaw(this.mContext, new ReentrantLock(), this.zabj, buildClientSettings, this.zacc, this.zacd, aVar, this.zace, this.zacf, aVar2, this.zaca, zaaw.zaa(aVar2.values(), true), arrayList, false);
    ...
    public abstract void stopAutoManage(C1071e eVar);
