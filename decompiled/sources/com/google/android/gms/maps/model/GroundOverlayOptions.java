...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBearing", mo13446id = 7)
    private float bearing;
    @Field(getter = "getHeight", mo13446id = 5)
    private float height;
    @Field(getter = "getWidth", mo13446id = 4)
    private float width;
    @Field(getter = "getZIndex", mo13446id = 8)
    private float zzcr;
    @Field(getter = "isVisible", mo13446id = 9)
    private boolean zzcs = true;
    @Field(getter = "isClickable", mo13446id = 13)
    private boolean zzct = false;
    @Field(getter = "getWrappedImageDescriptorImplBinder", mo13446id = 2, type = "android.os.IBinder")
    private BitmapDescriptor zzcw;
    @Field(getter = "getLocation", mo13446id = 3)
    private LatLng zzcx;
    @Field(getter = "getBounds", mo13446id = 6)
    private LatLngBounds zzcy;
    @Field(getter = "getTransparency", mo13446id = 10)
    private float zzcz = BitmapDescriptorFactory.HUE_RED;
    @Field(getter = "getAnchorU", mo13446id = 11)
    private float zzda = 0.5f;
    @Field(getter = "getAnchorV", mo13446id = 12)
    ...
    @Constructor
    GroundOverlayOptions(@Param(mo13449id = 2) IBinder iBinder, @Param(mo13449id = 3) LatLng latLng, @Param(mo13449id = 4) float f, @Param(mo13449id = 5) float f2, @Param(mo13449id = 6) LatLngBounds latLngBounds, @Param(mo13449id = 7) float f3, @Param(mo13449id = 8) float f4, @Param(mo13449id = 9) boolean z, @Param(mo13449id = 10) float f5, @Param(mo13449id = 11) float f6, @Param(mo13449id = 12) float f7, @Param(mo13449id = 13) boolean z2) {
