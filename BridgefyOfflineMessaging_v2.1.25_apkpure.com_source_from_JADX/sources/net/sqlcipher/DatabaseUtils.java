...
public class DatabaseUtils {
    ...
    public static class InsertHelper {
        ...
        private void buildSQL() throws net.sqlcipher.SQLException {
            /*
                ...
                r2.append(r1)
                r1 = 0
                net.sqlcipher.database.SQLiteDatabase r3 = r9.mDb     // Catch:{ all -> 0x00b6 }
                ...
                java.lang.String r5 = r9.mTableName     // Catch:{ all -> 0x00b6 }
                r4.append(r5)     // Catch:{ all -> 0x00b6 }
                java.lang.String r5 = ")"
                r4.append(r5)     // Catch:{ all -> 0x00b6 }
                java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x00b6 }
                net.sqlcipher.Cursor r3 = r3.rawQuery(r4, r1)     // Catch:{ all -> 0x00b6 }
                java.util.HashMap r1 = new java.util.HashMap     // Catch:{ all -> 0x00b4 }
                int r4 = r3.getCount()     // Catch:{ all -> 0x00b4 }
                r1.<init>(r4)     // Catch:{ all -> 0x00b4 }
                r9.mColumns = r1     // Catch:{ all -> 0x00b4 }
                r1 = 1
                r4 = 1
            L_0x004c:
                boolean r5 = r3.moveToNext()     // Catch:{ all -> 0x00b4 }
                if (r5 == 0) goto L_0x00a5
                java.lang.String r5 = r3.getString(r1)     // Catch:{ all -> 0x00b4 }
                r6 = 4
                java.lang.String r6 = r3.getString(r6)     // Catch:{ all -> 0x00b4 }
            ...
            L_0x0079:
                ...
                r2.append(r5)     // Catch:{ all -> 0x00b4 }
            L_0x0086:
                int r5 = r3.getCount()     // Catch:{ all -> 0x00b4 }
    ...
    private static char[] encodeHex(byte[] bArr, char[] cArr) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            i = i3 + 1;
            cArr2[i3] = cArr[bArr[i2] & Ascii.f6734SI];
        }
        return cArr2;
    }
