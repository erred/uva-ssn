...
public final class ServiceManager {
    ...
    private static final class ServiceManagerState {
        ...
        public void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                ...
                sb.append(Multimaps.filterKeys(this.servicesByState, Predicates.m8648in(ImmutableSet.m8708of(State.NEW, State.STARTING))));
        ...
        public void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, j, timeUnit)) {
                    ...
                    sb.append(Multimaps.filterKeys(this.servicesByState, Predicates.not(Predicates.m8648in(ImmutableSet.m8708of(State.TERMINATED, State.FAILED)))));
                    throw new TimeoutException(sb.toString());
                }
            } finally {
                this.monitor.leave();
        ...
        public ImmutableMap<Service, Long> startupTimes() {
            this.monitor.enter();
            try {
                ArrayList<Entry> newArrayListWithCapacity = Lists.newArrayListWithCapacity((this.states.size() - this.states.count(State.NEW)) + this.states.count(State.STARTING));
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        if (copyOf.isEmpty()) {
            ...
            copyOf = ImmutableList.m8669of(new NoOpService());
        }
