...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo13446id = 4)
    @Deprecated
    private final Scope[] zanx;
    @Field(getter = "getButtonSize", mo13446id = 2)
    private final int zapc;
    @Field(getter = "getColorScheme", mo13446id = 3)
    private final int zapd;

    @Constructor
    SignInButtonConfig(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) int i2, @Param(mo13449id = 3) int i3, @Param(mo13449id = 4) Scope[] scopeArr) {
        this.zale = i;
        this.zapc = i2;
        this.zapd = i3;
        this.zanx = scopeArr;
