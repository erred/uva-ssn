...
import com.google.android.gms.common.C2156R;
import com.google.android.gms.common.GooglePlayServicesUtil;
import com.google.android.gms.common.util.DeviceProperties;
import com.google.android.gms.common.wrappers.Wrappers;

public final class ConnectionErrorMessages {
    private static final C0725g<String, String> zaof = new C0725g<>();
    ...
    public static String getErrorTitle(Context context, int i) {
        ...
        if (i != 20) {
            switch (i) {
                case 1:
                    return resources.getString(C2152R.string.common_google_play_services_install_title);
                case 2:
                    return resources.getString(C2152R.string.common_google_play_services_update_title);
                case 3:
                    return resources.getString(C2152R.string.common_google_play_services_enable_title);
                case 4:
                case 6:
                    break;
                case 5:
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        return str == null ? context.getResources().getString(C2152R.string.common_google_play_services_notification_ticker) : str;
    }
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        if (i == 9) {
            return resources.getString(C2152R.string.common_google_play_services_unsupported_text, new Object[]{appName});
        } else if (i == 20) {
            return zaa(context, "common_google_play_services_restricted_profile_text", appName);
        } else {
            switch (i) {
                case 1:
                    return resources.getString(C2152R.string.common_google_play_services_install_text, new Object[]{appName});
                case 2:
                    if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                        return resources.getString(C2152R.string.common_google_play_services_wear_update_text);
                    }
                    return resources.getString(C2152R.string.common_google_play_services_update_text, new Object[]{appName});
                case 3:
                    return resources.getString(C2152R.string.common_google_play_services_enable_text, new Object[]{appName});
                default:
                    switch (i) {
                        case 16:
                        ...
                        case 18:
                            return resources.getString(C2152R.string.common_google_play_services_updating_text, new Object[]{appName});
                        default:
                            return resources.getString(C2156R.string.common_google_play_services_unknown_issue, new Object[]{appName});
                    }
            }
        }
    }
    ...
    public static String getErrorDialogButtonMessage(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C2152R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C2152R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C2152R.string.common_google_play_services_enable_button);
            default:
    ...
    private static String zaa(Context context, String str, String str2) {
        ...
        if (zaa == null) {
            zaa = resources.getString(C2156R.string.common_google_play_services_unknown_issue);
        }
    ...
    public static String getDefaultNotificationChannelName(Context context) {
        return context.getResources().getString(C2152R.string.common_google_play_services_notification_channel_name);
    }
