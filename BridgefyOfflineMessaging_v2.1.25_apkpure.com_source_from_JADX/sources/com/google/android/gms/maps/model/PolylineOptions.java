...
public final class PolylineOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getColor", mo13446id = 4)
    private int color;
    @Field(getter = "getWidth", mo13446id = 3)
    private float width;
    @Field(getter = "getZIndex", mo13446id = 5)
    private float zzcr;
    @Field(getter = "isVisible", mo13446id = 6)
    private boolean zzcs;
    @Field(getter = "isClickable", mo13446id = 8)
    private boolean zzct;
    @Field(getter = "getPoints", mo13446id = 2)
    private final List<LatLng> zzdw;
    @Field(getter = "isGeodesic", mo13446id = 7)
    private boolean zzdy;
    @Field(getter = "getStartCap", mo13446id = 9)
    private Cap zzeb;
    @Field(getter = "getEndCap", mo13446id = 10)
    private Cap zzec;
    @Field(getter = "getJointType", mo13446id = 11)
    private int zzed;
    @Field(getter = "getPattern", mo13446id = 12)
    ...
    @Constructor
    PolylineOptions(@Param(mo13449id = 2) List list, @Param(mo13449id = 3) float f, @Param(mo13449id = 4) int i, @Param(mo13449id = 5) float f2, @Param(mo13449id = 6) boolean z, @Param(mo13449id = 7) boolean z2, @Param(mo13449id = 8) boolean z3, @Param(mo13449id = 9) Cap cap, @Param(mo13449id = 10) Cap cap2, @Param(mo13449id = 11) int i2, @Param(mo13449id = 12) List<PatternItem> list2) {
        this.width = 10.0f;
        this.color = -16777216;
        this.zzcr = BitmapDescriptorFactory.HUE_RED;
        this.zzcs = true;
