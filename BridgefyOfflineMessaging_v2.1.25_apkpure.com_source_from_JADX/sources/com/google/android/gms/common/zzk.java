...
public final class zzk extends AbstractSafeParcelable {
    ...
    @Field(getter = "getAllowTestKeys", mo13446id = 3)
    private final boolean zzaa;
    @Field(getter = "getForbidTestKeys", mo13446id = 4)
    private final boolean zzab;
    @Field(getter = "getCallingPackage", mo13446id = 1)
    private final String zzy;
    @Field(getter = "getCallingCertificateBinder", mo13446id = 2, type = "android.os.IBinder")
    private final zze zzz;

    @Constructor
    zzk(@Param(mo13449id = 1) String str, @Param(mo13449id = 2) IBinder iBinder, @Param(mo13449id = 3) boolean z, @Param(mo13449id = 4) boolean z2) {
        this.zzy = str;
