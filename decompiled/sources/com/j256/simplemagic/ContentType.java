...
public enum ContentType {
    ...
    private static final Map<String, ContentType> fileExtensionMap = null;
    private static final Map<String, ContentType> mimeTypeMap = null;
    ...
    static {
        ...
        for (ContentType contentType : values()) {
            ...
            if (contentType.fileExtensions != null) {
                for (String put : contentType.fileExtensions) {
                    fileExtensionMap.put(put, contentType);
                }
            }
        }
    }

    private ContentType(String str, String str2, String... strArr) {
        this.mimeType = str;
    ...
    public static ContentType fromMimeType(String str) {
        ...
        ContentType contentType = (ContentType) mimeTypeMap.get(str);
        return contentType == null ? OTHER : contentType;
    }

    public static ContentType fromFileExtension(String str) {
        ContentType contentType = (ContentType) fileExtensionMap.get(str.toLowerCase());
        return contentType == null ? OTHER : contentType;
    }
}
