...
public class SignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(defaultValue = "", mo13446id = 4)
    @Deprecated
    private String zzba;
    @Field(getter = "getGoogleSignInAccount", mo13446id = 7)
    private GoogleSignInAccount zzbb;
    @Field(defaultValue = "", mo13446id = 8)
    @Deprecated
    private String zzbc;

    @Constructor
    SignInAccount(@Param(mo13449id = 4) String str, @Param(mo13449id = 7) GoogleSignInAccount googleSignInAccount, @Param(mo13449id = 8) String str2) {
