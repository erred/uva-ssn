...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBundle", mo13446id = 3)
    ...
    @Constructor
    GoogleSignInOptionsExtensionParcelable(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) int i2, @Param(mo13449id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
