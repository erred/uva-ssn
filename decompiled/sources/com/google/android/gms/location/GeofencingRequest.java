...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getParcelableGeofences", mo13446id = 1)
    private final List<zzbh> zzap;
    @Field(getter = "getInitialTrigger", mo13446id = 2)
    ...
    @Constructor
    GeofencingRequest(@Param(mo13449id = 1) List<zzbh> list, @Param(mo13449id = 2) int i, @Param(mo13449id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }
