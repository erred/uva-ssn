...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo13446id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo13446id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo13446id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo13446id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo13446id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo13446id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo13446id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo13446id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) ArrayList<Scope> arrayList, @Param(mo13449id = 3) Account account, @Param(mo13449id = 4) boolean z, @Param(mo13449id = 5) boolean z2, @Param(mo13449id = 6) boolean z3, @Param(mo13449id = 7) String str, @Param(mo13449id = 8) String str2, @Param(mo13449id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
