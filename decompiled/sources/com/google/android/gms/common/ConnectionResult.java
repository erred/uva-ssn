...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo13446id = 2)
    private final int zzh;
    @Field(getter = "getResolution", mo13446id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getErrorMessage", mo13446id = 4)
    private final String zzj;

    @Constructor
    ConnectionResult(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) int i2, @Param(mo13449id = 3) PendingIntent pendingIntent, @Param(mo13449id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzh)).add("resolution", this.zzi).add(MessageDTO.MESSAGE, this.zzj).toString();
    }
