...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    public JsonLocation getTokenLocation() {
        JsonLocation jsonLocation = new JsonLocation(this._ioContext.getSourceReference(), -1, getTokenCharacterOffset(), getTokenLineNr(), getTokenColumnNr());
        return jsonLocation;
    }
    ...
    public void _reportMismatchedEndMarker(int i, char c) throws JsonParseException {
        ...
        sb3.append(c);
        sb3.append("' (for ");
        sb3.append(this._parsingContext.typeDesc());
    ...
    public void reportOverflowInt() throws IOException {
        _reportError(String.format("Numeric value (%s) out of range of int (%d - %s)", new Object[]{getText(), Integer.valueOf(C1024a.INVALID_ID), Integer.valueOf(BaseClientBuilder.API_PRIORITY_OTHER)}));
    }
