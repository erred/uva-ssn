...
public abstract class DeserializationContext extends DatabindContext implements Serializable {
    ...
    public Object handleWeirdKey(Class<?> cls, String str, String str2, Object... objArr) throws IOException {
        ...
        while (problemHandlers != null) {
            Object handleWeirdKey = ((DeserializationProblemHandler) problemHandlers.value()).handleWeirdKey(this, cls, str, str2);
    ...
    public Object handleWeirdStringValue(Class<?> cls, String str, String str2, Object... objArr) throws IOException {
        ...
        LinkedNode problemHandlers = this._config.getProblemHandlers();
        while (problemHandlers != null) {
            Object handleWeirdStringValue = ((DeserializationProblemHandler) problemHandlers.value()).handleWeirdStringValue(this, cls, str, str2);
    ...
    public Object handleWeirdNumberValue(Class<?> cls, Number number, String str, Object... objArr) throws IOException {
        ...
        LinkedNode problemHandlers = this._config.getProblemHandlers();
        while (problemHandlers != null) {
            Object handleWeirdNumberValue = ((DeserializationProblemHandler) problemHandlers.value()).handleWeirdNumberValue(this, cls, number, str);
    ...
    public Object handleMissingInstantiator(Class<?> cls, JsonParser jsonParser, String str, Object... objArr) throws IOException {
        ...
        LinkedNode problemHandlers = this._config.getProblemHandlers();
        while (problemHandlers != null) {
            Object handleMissingInstantiator = ((DeserializationProblemHandler) problemHandlers.value()).handleMissingInstantiator(this, cls, jsonParser, str);
    ...
    public Object handleUnexpectedToken(Class<?> cls, JsonToken jsonToken, JsonParser jsonParser, String str, Object... objArr) throws IOException {
        ...
        for (LinkedNode problemHandlers = this._config.getProblemHandlers(); problemHandlers != null; problemHandlers = problemHandlers.next()) {
            Object handleUnexpectedToken = ((DeserializationProblemHandler) problemHandlers.value()).handleUnexpectedToken(this, cls, jsonToken, jsonParser, str);
    ...
    public JavaType handleUnknownTypeId(JavaType javaType, String str, TypeIdResolver typeIdResolver, String str2) throws IOException {
        ...
        while (problemHandlers != null) {
            ...
            if (handleUnknownTypeId == null) {
                ...
                sb.append(handleUnknownTypeId);
                throw unknownTypeIdException(javaType, str, sb.toString());
            }
        }
