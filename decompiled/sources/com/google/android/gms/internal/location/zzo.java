...
public final class zzo extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "DeviceOrientationRequestUpdateData.OPERATION_ADD", mo13446id = 1)
    private int zzcg;
    @Field(defaultValueUnchecked = "null", mo13446id = 2)
    private zzm zzch;
    @Field(defaultValueUnchecked = "null", getter = "getDeviceOrientationListenerBinder", mo13446id = 3, type = "android.os.IBinder")
    private zzr zzci;
    @Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo13446id = 4, type = "android.os.IBinder")
    private zzaj zzcj;

    @Constructor
    zzo(@Param(mo13449id = 1) int i, @Param(mo13449id = 2) zzm zzm, @Param(mo13449id = 3) IBinder iBinder, @Param(mo13449id = 4) IBinder iBinder2) {
        this.zzcg = i;
        this.zzch = zzm;
        zzaj zzaj = null;
