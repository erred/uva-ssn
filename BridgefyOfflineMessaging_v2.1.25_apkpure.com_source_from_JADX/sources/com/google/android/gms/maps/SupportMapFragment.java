...
public class SupportMapFragment extends C1062d {
    ...
    static class zza implements MapLifecycleDelegate {
        ...
        public zza(C1062d dVar, IMapFragmentDelegate iMapFragmentDelegate) {
        ...
        private final void zzc() {
            if (!(this.zzbd == null || this.zzbc == null || getDelegate() != null)) {
                try {
                    ...
                    IMapFragmentDelegate zzc = zzbz.zza((Context) this.zzbd).zzc(ObjectWrapper.wrap(this.zzbd));
                    if (zzc != null) {
