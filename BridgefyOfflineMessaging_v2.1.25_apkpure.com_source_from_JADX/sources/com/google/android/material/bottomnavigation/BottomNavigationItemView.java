...
public class BottomNavigationItemView extends FrameLayout implements C0552a {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C2167R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C2167R.C2169drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C2167R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C2167R.C2170id.icon);
        this.smallLabel = (TextView) findViewById(C2167R.C2170id.smallLabel);
        this.largeLabel = (TextView) findViewById(C2167R.C2170id.largeLabel);
        C0962r.m3569b((View) this.smallLabel, 2);
        C0962r.m3569b((View) this.largeLabel, 2);
        setFocusable(true);
    ...
    public void setEnabled(boolean z) {
        ...
        if (z) {
            ...
            C0962r.m3561a((View) this, (C0960p) null);
        }
    }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            C0983a.m3698a(drawable, this.iconTint);
        }
    ...
    public void setTextAppearanceInactive(int i) {
        C1013i.m3865a(this.smallLabel, i);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }

    public void setTextAppearanceActive(int i) {
        C1013i.m3865a(this.largeLabel, i);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }
    ...
    public void setItemBackground(int i) {
        setItemBackground(i == 0 ? null : C0875a.m3239a(getContext(), i));
    }
    ...
    public void setItemBackground(Drawable drawable) {
        ...
        C0962r.m3557a((View) this, drawable);
    }
}
