...
public final class zzal extends AbstractSafeParcelable {
    ...
    @Field(defaultValue = "", getter = "getTag", mo13446id = 3)
    private final String tag;
    @Field(getter = "getGeofenceIds", mo13446id = 1)
    private final List<String> zzbu;
    @Field(getter = "getPendingIntent", mo13446id = 2)
    private final PendingIntent zzbv;

    @Constructor
    zzal(@Param(mo13449id = 1) List<String> list, @Param(mo13449id = 2) PendingIntent pendingIntent, @Param(mo13449id = 3) String str) {
