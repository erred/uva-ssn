...
import androidx.core.app.C0854g.C0856b;
...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    static void zaa(Activity activity, Dialog dialog, String str, OnCancelListener onCancelListener) {
        if (activity instanceof C1071e) {
            SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((C1071e) activity).getSupportFragmentManager(), str);
            return;
        }
    ...
    private final void zaa(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            C0857c a = new C0857c(context).mo3503d(true).mo3501c(true).mo3490a((CharSequence) errorNotificationTitle).mo3489a((C0860e) new C0856b().mo3478a((CharSequence) errorNotificationMessage));
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                a.mo3481a(context.getApplicationInfo().icon).mo3499c(2);
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    a.mo3484a(C2152R.C2154drawable.common_full_open_on_phone, (CharSequence) resources.getString(C2152R.string.common_open_on_phone), pendingIntent);
                } else {
                    a.mo3486a(pendingIntent);
                }
            } else {
                a.mo3481a(17301642).mo3500c((CharSequence) resources.getString(C2152R.string.common_google_play_services_notification_ticker)).mo3485a(System.currentTimeMillis()).mo3486a(pendingIntent).mo3496b((CharSequence) errorNotificationMessage);
            }
            if (PlatformVersion.isAtLeastO()) {
