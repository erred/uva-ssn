...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @VersionField(mo13452id = 1000)
    private final int zale;
    @Field(getter = "getColumns", mo13446id = 1)
    private final String[] zalp;
    private Bundle zalq;
    @Field(getter = "getWindows", mo13446id = 2)
    private final CursorWindow[] zalr;
    @Field(getter = "getStatusCode", mo13446id = 3)
    private final int zals;
    @Field(getter = "getMetadata", mo13446id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo13449id = 1000) int i, @Param(mo13449id = 1) String[] strArr, @Param(mo13449id = 2) CursorWindow[] cursorWindowArr, @Param(mo13449id = 3) int i2, @Param(mo13449id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalw = true;
        this.zale = i;
        this.zalp = strArr;
