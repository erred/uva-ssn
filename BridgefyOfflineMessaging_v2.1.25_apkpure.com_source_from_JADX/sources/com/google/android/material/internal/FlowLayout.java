...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2167R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = obtainStyledAttributes.getDimensionPixelSize(C2167R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = obtainStyledAttributes.getDimensionPixelSize(C2167R.styleable.FlowLayout_itemSpacing, 0);
        ...
        if (getChildCount() != 0) {
            ...
            for (int i10 = 0; i10 < getChildCount(); i10++) {
                ...
                if (childAt.getVisibility() != 8) {
                    ...
                    if (layoutParams instanceof MarginLayoutParams) {
                        MarginLayoutParams marginLayoutParams = (MarginLayoutParams) layoutParams;
                        i5 = C0950f.m3503a(marginLayoutParams);
                        i6 = C0950f.m3505b(marginLayoutParams);
                    } else {
                        i6 = 0;
                        i5 = 0;
                    }
