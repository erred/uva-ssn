...
public class MaterialShapeDrawable extends Drawable implements C0984b {
    ...
    public void setShadowElevation(int i) {
        if (this.drawableState.shadowCompatElevation != i) {
            ...
            this.drawableState.shadowCompatElevation = i;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    private boolean requiresCompatShadow() {
        return VERSION.SDK_INT < 21 || !this.path.isConvex();
    }
    ...
    private boolean hasStroke() {
        return (this.drawableState.paintStyle == Style.FILL_AND_STROKE || this.drawableState.paintStyle == Style.STROKE) && this.strokePaint.getStrokeWidth() > BitmapDescriptorFactory.HUE_RED;
    }
    ...
    private float adjustCornerSizeForStrokeSize(float f) {
        return Math.max(f - getStrokeInsetLength(), BitmapDescriptorFactory.HUE_RED);
    }
    ...
    private PorterDuffColorFilter calculateTintFilter(ColorStateList colorStateList, Mode mode) {
