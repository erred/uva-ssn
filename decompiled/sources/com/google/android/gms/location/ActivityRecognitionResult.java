...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    public ActivityRecognitionResult(@Param(mo13449id = 1) List<DetectedActivity> list, @Param(mo13449id = 2) long j, @Param(mo13449id = 3) long j2, @Param(mo13449id = 4) int i, @Param(mo13449id = 5) Bundle bundle) {
        boolean z = true;
