...
public final class zzm extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo13446id = 3)
    private String tag;
    @Field(defaultValueUnchecked = "DeviceOrientationRequestInternal.DEFAULT_DEVICE_ORIENTATION_REQUEST", mo13446id = 1)
    private zzj zzcf;
    @Field(defaultValueUnchecked = "DeviceOrientationRequestInternal.DEFAULT_CLIENTS", mo13446id = 2)
    private List<ClientIdentity> zzm;

    @Constructor
    zzm(@Param(mo13449id = 1) zzj zzj, @Param(mo13449id = 2) List<ClientIdentity> list, @Param(mo13449id = 3) String str) {
        this.zzcf = zzj;
        this.zzm = list;
        this.tag = str;
    }
