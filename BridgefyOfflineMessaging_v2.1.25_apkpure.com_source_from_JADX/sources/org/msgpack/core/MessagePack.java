...
public class MessagePack {
    ...
    public static class UnpackerConfig implements Cloneable {
        ...
        private int stringSizeLimit = BaseClientBuilder.API_PRIORITY_OTHER;
        ...
        public int hashCode() {
            int i = 0;
            int hashCode = (((((this.allowReadingStringAsBinary ? 1 : 0) * true) + (this.allowReadingBinaryAsString ? 1 : 0)) * 31) + (this.actionOnMalformedString != null ? this.actionOnMalformedString.hashCode() : 0)) * 31;
            if (this.actionOnUnmappableString != null) {
                i = this.actionOnUnmappableString.hashCode();
            }
            return ((((((hashCode + i) * 31) + this.stringSizeLimit) * 31) + this.bufferSize) * 31) + this.stringDecoderBufferSize;
        }
