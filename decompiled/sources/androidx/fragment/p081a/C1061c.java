...
public class C1061c extends C1062d implements OnCancelListener, OnDismissListener {
    ...
    public void show(C1078i iVar, String str) {
        ...
        C1104o a = iVar.mo4370a();
        a.mo4069a((C1062d) this, str);
        a.mo4084c();
    }

    public int show(C1104o oVar, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        oVar.mo4069a((C1062d) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = oVar.mo4084c();
        return this.mBackStackId;
    }

    public void showNow(C1078i iVar, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        C1104o a = iVar.mo4370a();
        a.mo4069a((C1062d) this, str);
    ...
    public void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo4371a(this.mBackStackId, 1);
                this.mBackStackId = -1;
            } else {
                C1104o a = getFragmentManager().mo4370a();
                a.mo4068a((C1062d) this);
                if (z) {
                    a.mo4086d();
                } else {
                    a.mo4084c();
    ...
    public LayoutInflater onGetLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.mo4366i().getSystemService("layout_inflater");
        }
