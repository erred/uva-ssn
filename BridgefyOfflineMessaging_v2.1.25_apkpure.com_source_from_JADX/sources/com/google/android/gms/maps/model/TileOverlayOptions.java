...
public final class TileOverlayOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getZIndex", mo13446id = 4)
    private float zzcr;
    @Field(getter = "isVisible", mo13446id = 3)
    private boolean zzcs = true;
    @Field(getter = "getTransparency", mo13446id = 6)
    private float zzcz = BitmapDescriptorFactory.HUE_RED;
    /* access modifiers changed from: private */
    @Field(getter = "getTileProviderDelegate", mo13446id = 2, type = "android.os.IBinder")
    public zzaf zzeh;
    private TileProvider zzei;
    @Field(defaultValue = "true", getter = "getFadeIn", mo13446id = 5)
    ...
    @Constructor
    TileOverlayOptions(@Param(mo13449id = 2) IBinder iBinder, @Param(mo13449id = 3) boolean z, @Param(mo13449id = 4) float f, @Param(mo13449id = 5) boolean z2, @Param(mo13449id = 6) float f2) {
