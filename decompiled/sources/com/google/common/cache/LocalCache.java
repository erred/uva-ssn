    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        public V getAndRecordStats(K r4, int r5, com.google.common.cache.LocalCache.LoadingValueReference<K, V> r6, com.google.common.util.concurrent.ListenableFuture<V> r7) throws java.util.concurrent.ExecutionException {
            /*
                ...
                com.google.common.cache.AbstractCache$StatsCounter r0 = r3.statsCounter     // Catch:{ all -> 0x003d }
                long r1 = r6.elapsedNanos()     // Catch:{ all -> 0x003d }
                r0.recordLoadSuccess(r1)     // Catch:{ all -> 0x003d }
                r3.storeLoadedValue(r4, r5, r6, r7)     // Catch:{ all -> 0x003d }
            ...
            L_0x0020:
                return r7
            L_0x0021:
                com.google.common.cache.CacheLoader$InvalidCacheLoadException r0 = new com.google.common.cache.CacheLoader$InvalidCacheLoadException     // Catch:{ all -> 0x003d }
        ...
        /* access modifiers changed from: 0000 */
        public void enqueueNotification(K k, int i, ValueReference<K, V> valueReference, RemovalCause removalCause) {
        ...
        /* access modifiers changed from: 0000 */
        public ReferenceEntry<K, V> removeValueFromChain(ReferenceEntry<K, V> referenceEntry, ReferenceEntry<K, V> referenceEntry2, K k, int i, ValueReference<K, V> valueReference, RemovalCause removalCause) {
