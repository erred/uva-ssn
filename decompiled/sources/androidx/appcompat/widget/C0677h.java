...
public class C0677h extends CheckBox implements C1015j {
    private final C0679j mCompoundButtonHelper;
    private final C0705y mTextHelper;

    public C0677h(Context context) {
        this(context, null);
    }

    public C0677h(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.checkboxStyle);
    }

    public C0677h(Context context, AttributeSet attributeSet, int i) {
